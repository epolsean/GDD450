...
private var controller : ThirdPersonController1;
...
function Awake ()
{
	...
	if (_target)
	{
		controller = _target.GetComponent(ThirdPersonController1);
	}
	...
	if (controller)
	{
		...
		Debug.Log("Please assign a target to the camera that has a ThirdPersonController1 script attached.");
